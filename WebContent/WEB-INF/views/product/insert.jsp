...
<title>Sản phẩm|Thêm Son mới</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="sidebar">
		...
		<h2 class="lb">Thêm mới Son</h2>
		<p class="errors">${message}</p>
		<form:form action="product/insert.htm" method="post" modelAttribute="product" enctype="multipart/form-data">
			<div class="form-group">
				<label class="lb">Tên Son</label>
				<br>
			...
			<div class="form-group">
				...
				<br>
				<form:input type="number" class="frm" min="0" path="price" />
				<form:errors class="errors" path="price" />
			</div>
			
			<div class="form-group">
				<label class="lb">Loại Son</label>
				<br>
				<form:select class="f1" path="type.id" items="${types}" itemValue="id"
					itemLabel="name" />
			</div>
			
			<div class="form-group">
				<label class="lb">Mô tả Son</label>
				<br>
			...
			<div class="form-group">
				...
				<br>
				<form:input type="number" min="0" class="f1" path="amount" />
				<form:errors class="errors" path="amount" />
			</div>
			
			<div class="form-group">
			<br>
				<button class="btn" style="margin-left: 30%">Thêm Son</button>
			</div>
	</form:form>
	</div>
</body>
